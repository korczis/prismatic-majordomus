...
|---|---|---|---|---|
| `.bb/AGENTS.md` | `providers/bb` | markdown | 1476 | `f060f7a866a7d1a7` |
| `.dockerignore` | `deployment` | text | 573 | `b5411ad35adb24ea` |
| `AGENTS.md` | `providers/agents` | markdown | 5475 | `87c3e90b0d773d26` |
| `CLAUDE.md` | `providers/claude-code` | markdown | 4764 | `eb7a5e6fe67e2682` |
...
| `docs/generated/graph.json` | `graph` | json | 1804160 | `67336e09d61a19d2` |
...
| `share/allow/policy.txt` | `allow/policy` | text | 1472 | `3c47b9af53e39a64` |
...
| `site/data/registry/product-graph.json` | `site-product-graph` | json | 61048 | `23cb7a6bf773c28e` |
| `site/data/registry/product.json` | `site-product` | json | 305398 | `da6c02b126cc531a` |
| `site/data/registry/registry.json` | `site-registry` | json | 2557018 | `99d0910a0e6882d0` |
