+++
title = "Release"
description = "how a release's version and changelog are derived from the public contract rather than typed by hand: the four versions, the compatibility policy, `majordomus release …`, writing a change record, the diagnostics, and recovery when something goes wrong"
weight = 23
[extra]
