...
//! is a segment of its own and matches any number of segments, none included. There is no
//! character class, no brace expansion and no negation — a pattern this cannot express is a
//! pattern the layer does not use.
//!
