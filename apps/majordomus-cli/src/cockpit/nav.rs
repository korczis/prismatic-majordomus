...
//! Directories, Graphs, Continuity, Health, Artifacts, API. Those are concepts rather
//! than entities, they change when the Cockpit's own shape changes, and deriving them
//! from anything would be deriving them from a list of exactly themselves.
