...
[`CLI.md`](@/docs/cli-specification.md); this document is why it is shaped the way it is, and how to change
what it produces.
...
release see [`DISTRIBUTION.md`](@/docs/distribution.md); for publishing the repository's own
content see [`GITHUB_PAGES_ARCHITECTURE.md`](@/docs/github-pages-architecture.md).
{% endraw %}
