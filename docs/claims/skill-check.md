# Every skill is validated against the allow-list generated from its schema, its directory, its sections and its references, and a repository with no skills is reported rather than passed
