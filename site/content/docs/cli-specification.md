...
whether the task is active — until ADR 0041 it did, and a repository whose last task had
...
0041. Those two refusals are the 2026-09-05 outage: a task marked `handed_over` and never
