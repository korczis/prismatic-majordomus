...
) -> Result<EconomicsExplanation, CapabilityError> {
    ...
    fn the_declaration_yields_the_identity_and_the_projections_it_claims() {
        ...
        for (e, route, tool) in [
            (
                &m.capabilities[0],
                "/api/v1/economics",
                "majordomus_economics",
            ),
            (
                &m.capabilities[1],
                "/api/v1/economics/explain",
                "majordomus_economics_explain",
            ),
            (
                &m.capabilities[2],
                "/api/v1/economics/runs",
                "majordomus_economics_runs",
            ),
            (
                &m.capabilities[3],
                "/api/v1/economics/check",
                "majordomus_economics_check",
            ),
        ] {
            let c = &e.capability;
