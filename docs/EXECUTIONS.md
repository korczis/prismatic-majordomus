# Executions — watching a capability call happen
...
[ADR 22](../.ai/repo/adrs/0022-an-execution-is-a-watched-capability-call-not-a-second-registry.md);
...
the registry it runs on is [`CAPABILITIES.md`](CAPABILITIES.md).
...
Nothing extra. Write the `capability!` block as [`CAPABILITIES.md`](CAPABILITIES.md)
