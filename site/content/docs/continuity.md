...
that is never authored by the deriver: `verified` is a person's act. [`KNOWLEDGE.md`](@/docs/knowledge.md)
...
[`SCHEMAS.md`](@/docs/schemas.md) for the file formats · [`KNOWLEDGE.md`](@/docs/knowledge.md) for what an
episode learned and how it is derived · [`DESIGN.md`](@/docs/design.md) for why the models are
shaped this way.
{% endraw %}
