+++
title = "The install command this project advertises is fetched and run from the published site on every push to the default branch, and the branch is red while it does not install a working tool"
