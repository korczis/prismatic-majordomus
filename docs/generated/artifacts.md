...
| `site/data/registry/product-graph.json` | `site-product-graph` | json | 59514 | `ec9a4e057237c8fb` |
| `site/data/registry/product.json` | `site-product` | json | 300468 | `f9d292d734da9add` |
| `site/data/registry/registry.json` | `site-registry` | json | 1814082 | `4b71151fba39e999` |
