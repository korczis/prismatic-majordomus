...
```bash
curl -fsSL https://majordomus.dev/install.sh | sh -s -- --version v0.7.0
```

A pinned installation resolves `https://majordomus.dev/releases/v0.7.0.json`, which names the exact artifact and its
...
|---|---|---|---|---|
| `v0.7.0` (latest) | 2026-09-15 | stable | 6 | [`v0.7.0.json`](https://majordomus.dev/releases/v0.7.0.json) |
