...
description = "Entry reports a verdict per claim and the evidence behind it, from one preflight value"
weight = 53
[extra]
kind = "adr"
slug = "adr-0066"
identity = "adr-0066"
status = "proposed"
source = ".ai/repo/adrs/0066-entry-reports-a-verdict-per-claim-and-the-evidence-behind-it.md"
+++
{% raw %}
