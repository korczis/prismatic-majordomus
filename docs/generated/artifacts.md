...
| `distribution-dataset` | `json` | — | share/distribution.yaml and the release records |
| `distribution-matrix` | `json` | — | share/distribution.yaml and the release records |
| `install-guide` | `markdown` | — | share/distribution.yaml and the release records |
...
| `web` | `json`, `yaml` | `majordomus/web-topology/v1` | the web topology resolved from the producers that declare it |
| `why` | `json` | `majordomus-site-why/v1` | the Why catalogue, .ai/repo/why/ |
| `why-graph` | `json` | `majordomus-site-why-graph/v1` | the Why catalogue, .ai/repo/why/ |
...
| `docs/generated/benchmarks.json` | `benchmarks` | json | 11182 | `296877b3933fdcb0` |
| `docs/generated/benchmarks.md` | `benchmarks` | markdown | 5865 | `97c4c8eac1aeea3e` |
| `docs/generated/benchmarks.yaml` | `benchmarks` | yaml | 8138 | `6861da5b37c8069c` |
| `docs/generated/capabilities.md` | `capabilities` | markdown | 9044 | `8b2b21cd3647423a` |
| `docs/generated/cli.json` | `cli` | json | 221157 | `29e2a8d9e22d47d2` |
| `docs/generated/cli.md` | `cli` | markdown | 90136 | `9e749177efe66e1b` |
| `docs/generated/cli.yaml` | `cli` | yaml | 172066 | `0b501655ebb2e0e4` |
| `docs/generated/distribution-matrix.json` | `distribution-matrix` | json | 2731 | `5a751fe649405830` |
...
| `docs/generated/openapi.json` | `openapi` | json | 298512 | `7ad1d29f091b2941` |
| `docs/generated/openapi.yaml` | `openapi` | yaml | 230107 | `5c22f270c32f6d34` |
| `docs/generated/registry.json` | `registry` | json | 334336 | `999d46e3d3a3c6e0` |
| `docs/generated/registry.yaml` | `registry` | yaml | 253805 | `7aafe14cb93d15b3` |
| `docs/generated/web.json` | `web` | json | 4079 | `90a913535f90b79f` |
| `docs/generated/web.yaml` | `web` | yaml | 3162 | `92661e2037f814c7` |
...
| `share/allow/manifest.txt` | `allow/manifest` | text | 627 | `7065da42c0fb261c` |
...
| `site/data/registry/distribution.json` | `distribution-dataset` | json | 2907 | `fdd41c793553920f` |
| `site/data/registry/registry.json` | `site-registry` | json | 1143614 | `09e3e09e70246911` |
| `site/data/registry/why-graph.json` | `why-graph` | json | 178577 | `6438471b01c9c73f` |
| `site/data/registry/why.json` | `why` | json | 349448 | `c523d836dedb4eb9` |
