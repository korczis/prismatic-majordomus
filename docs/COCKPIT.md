...
That arrived, and that is [ADR 22](../.ai/repo/adrs/0022-an-execution-is-a-watched-capability-call-not-a-second-registry.md):
...
([`EXECUTIONS.md`](EXECUTIONS.md)). What did *not* change is the trade the paragraph
