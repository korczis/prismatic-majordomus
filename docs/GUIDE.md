# Guide — what Majordomus does for a team, how each part works, and the tests that prove it

This is the practical companion to two other documents. [`CONCEPTS.md`](CONCEPTS.md) is the
vocabulary; [`HOW_IT_WORKS.md`](HOW_IT_WORKS.md) is the architecture. This one goes feature by
