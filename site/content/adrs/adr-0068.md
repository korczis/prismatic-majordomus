...
description = "CI evidence is kept where the run happened, and published with the commit it proves"
weight = 53
[extra]
kind = "adr"
slug = "adr-0068"
identity = "adr-0068"
status = "proposed"
source = ".ai/repo/adrs/0068-ci-evidence-is-kept-where-the-run-happened-and-published-with-the-commit-it-proves.md"
+++
{% raw %}
