# A decision states what it put in force as typed references, each one validated, and the reverse direction is read from the knowledge graph rather than written down a second time
