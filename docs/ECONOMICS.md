...
contains none. The numbers are in [`generated/economics.md`](generated/economics.md), written
...
[`.ai/repo/benchmarks/economics/methodology.yaml`](../.ai/repo/benchmarks/economics/methodology.yaml).
...
Seven tasks in [`.ai/repo/benchmarks/economics/tasks/`](../.ai/repo/benchmarks/economics/tasks/),
