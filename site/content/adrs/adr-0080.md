...
description = "A CI run reaches the tracked ledger through a recording branch, never through the run that produced it"
weight = 53
[extra]
kind = "adr"
slug = "adr-0080"
identity = "adr-0080"
status = "proposed"
source = ".ai/repo/adrs/0080-a-recorded-run-reaches-the-tracked-ledger-through-a-recording-branch.md"
+++
{% raw %}
