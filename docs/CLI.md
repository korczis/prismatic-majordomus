...
switch that is off is said on stderr and derives nothing. [`KNOWLEDGE.md`](KNOWLEDGE.md) has
...
[`KNOWLEDGE.md`](KNOWLEDGE.md) has the derivation table, the two moments and the rules.
