...
use_cases: [install-the-tool-in-one-command, serve-the-layer-to-ai-clients, extend-what-the-executable-serves, classify-what-belongs-in-the-context, find-an-object-without-reading-everything, keep-the-bootstrap-thin-and-within-budget, read-only-the-context-that-fits, trace-a-change-to-the-context-it-affects, follow-a-skill-the-repository-defines, see-what-the-repository-holds-without-reading-it, say-what-the-tool-is-for, work-on-a-branch-in-its-canonical-worktree]
