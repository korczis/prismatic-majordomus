...
identity = "project.github-projection-gated@1"
status = "active"
source = ".ai/repo/rules/project/github-projection-gated.v1.md"
+++
{% raw %}
...
- The backlog of a projection that stopped being applied is ratcheted against a committed
  ...
  [`.ai/repo/claim-proof-baseline.txt`](https://github.com/korczis/prismatic-majordomus/blob/master/.ai/repo/claim-proof-baseline.txt).
