...
| `worktree` | Worktree topology | behaviorally_verified | 3 | [`modules/worktree.md`](modules/worktree.md) |
...
| `worktree.list` | `worktree` | query | behaviorally_verified | `majordomus_worktrees` | `majordomus://worktrees` | `GET /api/v1/worktrees` | `majordomus worktree list` | — | required |
| `worktree.root` | `worktree` | query | behaviorally_verified | `majordomus_worktree_root` | — | `GET /api/v1/worktree/root` | `majordomus worktree root` | — | required |
| `worktree.status` | `worktree` | query | behaviorally_verified | `majordomus_worktree_status` | — | `GET /api/v1/worktree/status` | `majordomus worktree status` | — | required |
