...
| `commands.get` | commands | query | process, 32 entries | covered | covered | covered | `one` |
| `commands.list` | commands | query | process, 16 entries | covered | covered | covered | `all`, `by-namespace`, `by-effect` |
