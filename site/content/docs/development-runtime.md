...
of the file already did. It is already the pure projection that [`COCKPIT.md`](@/docs/cockpit.md) and ADR 0013
...
| Cockpit | `src/cockpit/` | none | a person | — | [`COCKPIT.md`](@/docs/cockpit.md) | **clean** — no layer reference at all; the one display label ADR 0040 recorded is now prose |
