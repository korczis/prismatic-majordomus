...
use_cases: [install-the-tool-in-one-command, adopt-an-existing-repository, prove-a-rule-is-enforced, find-out-what-drifted, extend-what-the-executable-serves, add-a-use-case-and-prove-it, migrate-from-the-old-layout, read-the-rules-the-tool-applies, classify-what-belongs-in-the-context, keep-the-bootstrap-thin-and-within-budget, trace-a-change-to-the-context-it-affects, document-every-directory-of-the-layer, trust-the-policy-before-reading-it, follow-a-skill-the-repository-defines, see-what-the-repository-holds-without-reading-it, say-what-the-tool-is-for, keep-what-an-episode-learned]
