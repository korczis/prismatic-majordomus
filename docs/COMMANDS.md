...
- [`CAPABILITIES.md`](CAPABILITIES.md) — the capability registry the graph joins against
- [`ENVIRONMENT.md`](ENVIRONMENT.md) — the typed snapshot repository entry renders
- [`DYNAMICITY.md`](DYNAMICITY.md) — the ownership rule this is an instance of
- [`CLI.md`](CLI.md) — the shell tool's own command specification
