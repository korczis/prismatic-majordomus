...
use_cases: [serve-the-layer-to-ai-clients, extend-what-the-executable-serves, classify-what-belongs-in-the-context, find-an-object-without-reading-everything, keep-the-bootstrap-thin-and-within-budget, read-only-the-context-that-fits, trace-a-change-to-the-context-it-affects, follow-a-skill-the-repository-defines]
