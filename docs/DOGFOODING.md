...
- [`docs/PLANNING.md`](PLANNING.md) — what the model means
- [`docs/CONTINUITY.md`](CONTINUITY.md) — what survives a session ending
- [`docs/DOCTRINE.md`](DOCTRINE.md) — how a rule becomes enforced rather than documented
