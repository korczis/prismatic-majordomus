...
const PAGES: &[&str] = &[
    ...
    "/cockpit/artifacts",
    "/cockpit/knowledge",
    "/cockpit/knowledge/nodes",
    "/cockpit/knowledge/nodes?kind=document",
    "/cockpit/knowledge/node?id=document:README.md",
    "/cockpit/knowledge/graph",
    "/cockpit/knowledge/impact",
    "/cockpit/knowledge/coverage",
    "/cockpit/knowledge/gaps",
    "/cockpit/knowledge/conflicts",
    "/cockpit/knowledge/sources",
    "/cockpit/knowledge/diagnostics",
    "/cockpit/integrity",
    "/cockpit/integrity/rks.status",
    "/cockpit/api",
    "/cockpit/search",
    "/cockpit/activity",
