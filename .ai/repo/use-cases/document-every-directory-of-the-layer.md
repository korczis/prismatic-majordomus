...
summary: 'A directory added under the layer without a context document fails validation by name, and nothing resolves against the tree until it says what it is for.'
category: knowledge
status: active
target: guaranteed
weight: 71
