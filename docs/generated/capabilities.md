...
| `release` | Release | behaviorally_verified | 8 | [`modules/release.md`](modules/release.md) |
...
| `release.changelog` | `release` | query | behaviorally_verified | `majordomus_changelog` | — | `GET /api/v1/release/changelog` | `majordomus release changelog` | — | required |
| `release.check` | `release` | query | behaviorally_verified | `majordomus_release_check` | — | `GET /api/v1/release/check` | `majordomus release check` | — | required |
| `release.diff` | `release` | query | behaviorally_verified | `majordomus_release_diff` | — | `GET /api/v1/release/diff` | `majordomus release diff` | — | required |
| `release.explain` | `release` | query | behaviorally_verified | `majordomus_release_explain` | — | `GET /api/v1/release/explain` | `majordomus release explain` | — | required |
| `release.manifest` | `release` | query | behaviorally_verified | `majordomus_release_manifest` | — | `GET /api/v1/release/manifest` | `majordomus release manifest` | — | required |
| `release.plan` | `release` | query | behaviorally_verified | `majordomus_release_plan` | — | `GET /api/v1/release/plan` | `majordomus release plan` | — | required |
| `release.status` | `release` | query | behaviorally_verified | `majordomus_release_status` | `majordomus://release` | `GET /api/v1/release/status` | `majordomus release status` | — | required |
| `release.version` | `release` | query | behaviorally_verified | `majordomus_version` | — | `GET /api/v1/release/version` | `majordomus release version` | — | required |
