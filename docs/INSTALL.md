...
```bash
curl -fsSL https://majordomus.dev/install.sh | sh -s -- --version v0.8.0
```

A pinned installation resolves `https://majordomus.dev/releases/v0.8.0.json`, which names the exact artifact and its
...
|---|---|---|---|---|
| `v0.8.0` (latest) | 2026-09-20 | stable | 6 | [`v0.8.0.json`](https://majordomus.dev/releases/v0.8.0.json) |
