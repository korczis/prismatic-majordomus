...
summary: 'Open the shared server in a browser and get the whole layer as pages: what exists, where each thing came from, what depends on what, what is failing, and a form that runs any capability.'
category: mcp
status: active
target: guaranteed
weight: 6
actors: [operator, reviewer, maintainer]
difficulty: basic
commands: [doctor, knowledge]
mcp_tools: [majordomus_health, majordomus_graph, majordomus_graphs, majordomus_perf]
doctrines: [majordomus.projection-integrity, majordomus.ai-layout-integrity]
