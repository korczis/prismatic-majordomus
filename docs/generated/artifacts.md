...
| `apps/majordomus-cli/src/cockpit/logo-mark.svg` | `design-mark` | text | 903 | `4a0cab33442c2ebe` |
| `apps/majordomus-cli/src/design/tokens.yaml` | `design-declaration` | yaml | 14064 | `0a5e431c61e1a036` |
| `apps/majordomus-cli/src/web/tokens.css` | `design-tokens` | text | 4618 | `6b5f8bcb1ba39418` |
...
| `docs/generated/benchmarks.json` | `benchmarks` | json | 21800 | `b590c2f750177310` |
| `docs/generated/benchmarks.md` | `benchmarks` | markdown | 10067 | `e934c5a86bda9736` |
| `docs/generated/benchmarks.yaml` | `benchmarks` | yaml | 15467 | `9faa436b5f671653` |
| `docs/generated/capabilities.md` | `capabilities` | markdown | 17842 | `d36f87b2069e8fb5` |
...
| `docs/generated/cli.json` | `cli` | json | 500936 | `ff38f3fb17cc14fc` |
| `docs/generated/cli.md` | `cli` | markdown | 210553 | `3054ae8f7de94546` |
| `docs/generated/cli.yaml` | `cli` | yaml | 389641 | `4476eda12c4827b6` |
| `docs/generated/design.json` | `design` | json | 109448 | `718e41ca586a7d10` |
| `docs/generated/design.md` | `design` | markdown | 7533 | `4a99a9d819424829` |
| `docs/generated/design.yaml` | `design` | yaml | 89025 | `92eab8096096b6ea` |
...
| `docs/generated/modules/design.md` | `modules/design` | markdown | 3095 | `3177cb593d372619` |
...
| `docs/generated/openapi.json` | `openapi` | json | 753849 | `7778c524dd8f44ac` |
| `docs/generated/openapi.yaml` | `openapi` | yaml | 586510 | `e4152059c09daf97` |
...
| `docs/generated/registry.json` | `registry` | json | 1011357 | `5a47a91f41f94c6e` |
| `docs/generated/registry.yaml` | `registry` | yaml | 779069 | `8146561dcbb12e16` |
| `docs/generated/web.json` | `web` | json | 5226 | `92fdff6130a027d8` |
| `docs/generated/web.yaml` | `web` | yaml | 3999 | `6dfaafeb3ef6214a` |
...
| `share/cockpit/favicon.svg` | `design-mark` | text | 903 | `4a0cab33442c2ebe` |
| `share/design/status.css` | `design-status` | text | 9558 | `3d214d0f807463bc` |
| `share/design/surface.css` | `design-surface` | text | 2858 | `946c47b744b237b0` |
| `share/design/theme.css` | `design-theme` | text | 2378 | `6d7461eeefc97008` |
...
| `site/data/registry/design.json` | `site-design` | json | 8004 | `989e5f54e4f03f8e` |
| `site/data/registry/distribution.json` | `site-distribution` | json | 3121 | `5d94a01ea33c9e24` |
| `site/data/registry/product-graph.json` | `site-product-graph` | json | 60224 | `285917a151be9dd2` |
| `site/data/registry/product.json` | `site-product` | json | 304011 | `caf31dee7d029f44` |
| `site/data/registry/registry.json` | `site-registry` | json | 2375043 | `8bc3076033deadf2` |
...
| `site/static/favicon.svg` | `design-mark` | text | 903 | `4a0cab33442c2ebe` |
| `site/static/images/logo-mark.svg` | `design-mark` | text | 903 | `4a0cab33442c2ebe` |
| `site/static/images/logo.svg` | `design-logo` | text | 1058 | `70d4956414346be2` |
