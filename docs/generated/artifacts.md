...
|---|---|---|---|---|
| `.bb/AGENTS.md` | `providers/bb` | markdown | 1476 | `bbb7ce4b0d63bd2d` |
| `.dockerignore` | `deployment` | text | 573 | `b5411ad35adb24ea` |
| `AGENTS.md` | `providers/agents` | markdown | 5475 | `61b09d7b3e0fe68e` |
| `CLAUDE.md` | `providers/claude-code` | markdown | 4764 | `65bbd2d41f5ccb17` |
...
| `docs/generated/graph.json` | `graph` | json | 1827273 | `8645ae271bebe5e8` |
...
| `share/allow/policy.txt` | `allow/policy` | text | 1439 | `0fa5233bd1a75758` |
...
| `site/data/registry/product.json` | `site-product` | json | 312936 | `bbad309728869ca1` |
| `site/data/registry/registry.json` | `site-registry` | json | 2684209 | `50d525f5c95e8131` |
