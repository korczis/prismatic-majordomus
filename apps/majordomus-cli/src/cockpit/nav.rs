...
//!
//! What *is* written here is the seven areas: Overview, Capabilities, Objects,
//! Directories, Graphs, Health, API. Those are concepts rather than entities, they change when the Cockpit's
