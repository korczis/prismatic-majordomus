...
headline: A rule is enforced when a validator decides it, a command runs it, a test proves it and CI reports that test honestly; anything less is documentation, and the tool knows the difference.
