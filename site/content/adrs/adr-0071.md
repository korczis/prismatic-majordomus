...
description = "A feature exists only when its delivery is computed and every dimension passes"
weight = 53
[extra]
kind = "adr"
slug = "adr-0071"
identity = "adr-0071"
status = "proposed"
source = ".ai/repo/adrs/0071-a-feature-exists-only-when-delivery-is-computed-and-every-dimension-passes.md"
+++
{% raw %}
...
worker, green on CI to another, visible on the site to a third. [ADR 41](@/adrs/adr-0041.md)
