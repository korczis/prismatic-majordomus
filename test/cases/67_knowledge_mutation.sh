...
"$MJ" init >/dev/null
mkdir -p docs .majordomus/project/milestones .majordomus/project/issues lib test/cases
...
EOF
mk_milestone() {
  cat > ".majordomus/project/milestones/$1.yaml" <<EOF
id: $1
title: Outcome $1
slug: outcome-$1
order: $2
...
mk_issue() {
  cat > ".majordomus/project/issues/$1.yaml" <<EOF
id: $1
milestone: $2
title: Issue $1
slug: issue-$1
...
sed 's/^  - I0101$/  - I0199/' .majordomus/project/issues/I0102.yaml > i.tmp
mv i.tmp .majordomus/project/issues/I0102.yaml
mk_issue I0199 M200
git add -A >/dev/null && git commit -q -m redirect
snapshot after.txt
expect_no_grep '^depends_on +issue:I0102 +issue:I0101' after.txt
expect_grep '^depends_on +issue:I0102 +issue:I0199 +\.majordomus/project/issues/I0102\.yaml:depends_on\.0' after.txt
...
sed 's/^milestone: M100$/milestone: M200/' .majordomus/project/issues/I0102.yaml > i.tmp
mv i.tmp .majordomus/project/issues/I0102.yaml
...
rm .majordomus/project/issues/I0199.yaml
