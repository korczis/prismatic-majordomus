...
/// A capability is presented by its id: the CLI's table, the site's registry pages and the
/// closure matrix all list it that way, and a title is neither unique nor stable enough to
/// be the thing a reader navigates by.
