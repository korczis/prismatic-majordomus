...
summary: 'Start a branch without choosing a path, find every checkout of the repository from any of them, and bring a stray one home with its uncommitted work intact.'
category: workers
status: active
target: guaranteed
weight: 7
...
mcp_tools: [majordomus_worktrees, majordomus_worktree_status, majordomus_worktree_inspect, majordomus_worktree_migration_plan]
doctrines: [majordomus.enforcement-wiring, majordomus.scope-integrity]
