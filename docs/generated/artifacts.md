...
|---|---|---|---|---|
| `.bb/AGENTS.md` | `providers/bb` | markdown | 1476 | `132a07dc5e923537` |
| `.dockerignore` | `deployment` | text | 573 | `b5411ad35adb24ea` |
| `AGENTS.md` | `providers/agents` | markdown | 5475 | `34c4721d17d5d0a5` |
| `CLAUDE.md` | `providers/claude-code` | markdown | 4764 | `bb6889a993ba3c34` |
...
| `docs/generated/graph.json` | `graph` | json | 1804686 | `a5b69f72e2f08428` |
...
| `share/allow/policy.txt` | `allow/policy` | text | 1400 | `7e370b70958b521d` |
...
| `site/data/registry/product-graph.json` | `site-product-graph` | json | 61048 | `21d911001c9fc82b` |
| `site/data/registry/product.json` | `site-product` | json | 305491 | `5a0af3819c9e0bc3` |
| `site/data/registry/registry.json` | `site-registry` | json | 2553811 | `947ff5a0d814f487` |
