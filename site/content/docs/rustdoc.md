...
and thin documentation to `project.rust-public-api-quality` ([`QUALITY.md`](@/docs/quality.md)).
...
mount is its own top-level one; [`WEB.md`](@/docs/web.md) explains why `/docs`, `/api` and
...
queue or GitHub's own Pages build, which [`GITHUB_PAGES_PERFORMANCE.md`](@/docs/github-pages-performance.md)
