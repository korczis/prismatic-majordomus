...
| `docs/generated/graph.json` | `graph` | json | 2023443 | `73156c7dcb37b9f0` |
...
| `site/data/registry/product-graph.json` | `site-product-graph` | json | 68040 | `afbae33b9afc3e37` |
| `site/data/registry/product.json` | `site-product` | json | 332468 | `882c97ef86d6abb5` |
| `site/data/registry/registry.json` | `site-registry` | json | 3299160 | `62c2459ab7317857` |
