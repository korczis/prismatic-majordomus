...
//!
//! What *is* written here is the twelve areas: Overview, Capabilities, Commands,
//! Objects, Directories, Graphs, Continuity, Worktrees, Health, Quality, Artifacts, API.
//! Those are concepts rather than
