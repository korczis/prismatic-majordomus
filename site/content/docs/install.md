...
```bash
curl -fsSL https://majordomus.dev/install.sh | sh -s -- --version v0.6.0
```

A pinned installation resolves `https://majordomus.dev/releases/v0.6.0.json`, which names the exact artifact and its
...
|---|---|---|---|---|
| `v0.6.0` (latest) | 2026-09-12 | stable | 6 | [`v0.6.0.json`](https://majordomus.dev/releases/v0.6.0.json) |
| `v0.5.0` | 2026-09-11 | stable | 6 | [`v0.5.0.json`](https://majordomus.dev/releases/v0.5.0.json) |
