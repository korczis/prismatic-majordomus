...
| `docs/generated/graph.json` | `graph` | json | 2060524 | `54c76dab3d752cce` |
...
| `site/data/registry/product-graph.json` | `site-product-graph` | json | 71416 | `7ed3025c05eea299` |
| `site/data/registry/product.json` | `site-product` | json | 346662 | `a3ea6d2dab933747` |
| `site/data/registry/registry.json` | `site-registry` | json | 3485692 | `b391cedf26e6603d` |
