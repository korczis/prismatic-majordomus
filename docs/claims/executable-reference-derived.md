# The site's pages about the Rust executable are derived from the registry, and a capability that joins or leaves it gains or loses its page from the generators alone
