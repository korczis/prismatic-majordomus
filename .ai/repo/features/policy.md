...
short_title: Policy
headline: Claude Code, Codex, Gemini CLI and any tool that reads AGENTS.md get the same rules from the same place, because their instruction files are generated from one policy and never written by hand.
