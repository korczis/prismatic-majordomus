...
| `docs/generated/graph.json` | `graph` | json | 2020075 | `28f4ca0e9f4a7efd` |
...
| `site/data/registry/product-graph.json` | `site-product-graph` | json | 68040 | `7a86c57c4d0ec4f7` |
| `site/data/registry/product.json` | `site-product` | json | 332468 | `2040f27f200bd791` |
| `site/data/registry/registry.json` | `site-registry` | json | 3295260 | `6b55ed6f936bb681` |
